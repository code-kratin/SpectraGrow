disease_dic = {
    ...
    'Cherry_(including_sour)___Powdery_mildew': """ <b>Crop</b>: Cherry <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:
        <br/><br/>Podos"ph"aera clandestina, a fungus that most commonly infects young, expanding leaves but can also be found on buds, fruit and fruit stems. It overwinters as small, round, black bodies (chasmothecia) on dead leaves, on the orchard floor, or in tree crotches. Colonies produce more (asexual) spores generally around shuck fall and continue the disease cycle.
        <br/><br/> How to prevent/cure the disease <br/>
    ...
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ <b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
        <br/><br/>Gray leaf spot lesions on corn leaves hinder "ph"otosynthetic activity, reducing carbohydrates allocated towards g"rain" fill. The extent to which gray leaf spot damages crop yields can be estimated based on the extent to which leaves are infected relative to g"rain"fill. Damage can be more severe when developing lesions progress past the ear leaf around pollination time.	Because a decrease in functioning leaf area limits "ph"otosynthates dedicated towards g"rain"fill, the plant might mobilize more carbohydrates from the stalk to fill kernels.
        <br/><br/> How to prevent/cure the disease <br/>
        ...
        <br/>2. This is done by limiting the amount of secondary disease cycles and protecting leaf area from damage until after corn g"rain" formation.
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """ <b>Crop</b>: Corn(maize) <br/>Disease: Northern Leaf Blight
        <br/>
        <br/> Cause of disease:
        <br/><br/>Northern corn leaf blight (NCLB) is a foliar disease of corn (maize) caused by Exserohilum turcicum, the anamor"ph" of the ascomycete Setos"ph"aeria turcica. With its characteristic cigar-shaped lesions, this disease can cause significant yield loss in susceptible corn hybrids.
        <br/><br/> How to prevent/cure the disease <br/>
    ...
    'Grape___Esca_(Black_Measles)': """ <b>Crop</b>: Grape <br/>Disease: Black Measles<br/>
        <br/> Cause of disease:
        <br/><br/> 1. Black Measles is caused by a complex of fungi that includes several species of "Ph"aeoacremonium, primarily by P. aleo"ph"ilum (currently known by the name of its sexual stage, Togninia minima), and by "Ph"aeomoniella chlamydospora.
        ...
        <br/> 3. During fall to spring "rain"fall, spores are released and wounds made by dormant pruning provide infection sites.
        ...
        <br/>2. Sanitation and vine surgery may help maintain yields. In spring, look for dead spurs or for stunted shoots. Later in summer, when there is a reduced chance of "rain"fall, practice good sanitation by cutting off these cankered portions of the vine beyond the canker, to where wood appears healthy. Then remove diseased, woody debris from the vineyard and destroy it.
    ...
    'Potato___Late_blight': """ <b>Crop</b>: Potato <br/>Disease: Late Blight<br/>
        ...
        <br/> Cause of disease:
        <br/><br/> 1. Late blight is caused by the oomycete "Ph"yto"ph"thora infestans. Oomycetes are fungus-like organisms also called water molds, but they are not true fungi.
        <br/> 2. There are many different st"rain"s of P. infestans. These are called clonal lineages and designated by a number code (i.e. US-23). Many clonal lineages affect both tomato and potato, but some lineages are specific to one host or the other.
        <br/> 3. The host range is typically limited to potato and tomato, but hairy nightshade (Solanum "ph"ysalifolium) is a closely related weed that can readily become infected and may contribute to disease spread. Under ideal conditions, such as a greenhouse, petunia also may become infected.
    ...
    'Tomato___Early_blight': """ <b>Crop</b>: Tomato <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
        <br/><br/> 1. Early blight can be caused by two different closely related fungi, Alternaria tomato"ph"ila and Alternaria solani.
        <br/> 2. Alternaria tomato"ph"ila is more virulent on tomato than A. solani, so in regions where A. tomato"ph"ila is found, it is the primary cause of early blight on tomato. However, if A.tomato"ph"ila is absent, A.solani will cause early blight on tomato.
        <br/><br/> How to prevent/cure the disease <br/>
        ...
        <br/>4. Fertilize properly to maintain vigorous plant growth. Particularly, do not over-fertilize with potassium and maintain adequate levels of both nitrogen and "ph"os"ph"orus.
